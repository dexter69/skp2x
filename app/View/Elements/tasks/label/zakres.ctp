...
<form class="form-inline zakres">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="prefix<?= $id ?>" placeholder="prefix">
    </div>
    <div class="form-group">
        <label class="sr-only" for="start<?= $id ?>">Start</label>
        <input type="text" class="form-control" id="start<?= $id ?>" placeholder="start">
    </div>
    <div class="form-group">
        <label class="sr-only" for="suffix<?= $id ?>">Prefix</label>
        <input type="text" class="form-control" id="suffix<?= $id ?>" placeholder="suffix">
    </div>
</form>